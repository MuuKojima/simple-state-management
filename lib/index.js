...
var SimpleStateManagement = /*#__PURE__*/function () {
  ...
  _createClass(SimpleStateManagement, [{
    ...
    value: function dispatch(actionName, payload) {
      var action = this.findNestedObj(this.actions, actionName);
    ...
    value: function commit(mutationName, payload) {
      var mutation = this.findNestedObj(this.mutations, mutationName);
    ...
    value: function getters(getterName, payload) {
      var getter = this.findNestedObj(this.getters_, getterName);
    ...
    key: "findNestedObj",
    value: function findNestedObj(obj, name) {
      var paths = name.split('.'); // Oliver Steele’s pattern
